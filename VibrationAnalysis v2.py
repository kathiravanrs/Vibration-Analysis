...
fourier_y = (abs(fourier_y))**2
fourier_x = (abs(fourier_x))**2

# The np array is converted into a list
fourier_x_list = []
for i in fourier_x:
...
plot = figure(title="Vibration X fft", plot_width=1500, plot_height=700)
plot.line(frq, fourier_x_list)
show(plot)

output_file("plot_y.html")
plot = figure(title="Vibration Y fft", plot_width=1500, plot_height=700)
